...
【解決過程】
1. 分析需求：需要專業安全分析
2. 切換專家模式：/agents:security-auditor
3. 執行全面掃描：claude /security-review ./src
4. 生成專業報告：/output-style:security-report
5. 記錄經驗：/memory

【學習重點】遇到專業問題 → 切換對應專家代理人
```
